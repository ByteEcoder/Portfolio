            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">sumit.ac.in</span>

                        <a href="mailto:sumit.23scse1410063@galgotiasuniversity.ac.in" className="contact__button">Write me <i className="bx bx-right-arrow-alt"></i></a>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <a href="https://www.linkedin.com/in/byteecoder/" className="contact__button">Write me <i className="bx bx-right-arrow-alt"></i></a>
                    </div>
